...
class MyScaleSearcher(BaseSearcher):
    ...
    @PROFILER.profile_function("database.MyScaleSearcher.profile")
    def search(
        self,
        query_list: list,
        num_selected: int,
