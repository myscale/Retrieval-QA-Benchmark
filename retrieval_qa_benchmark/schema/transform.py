...
from typing import Any, Callable, Dict, List, Optional, Tuple, Union, cast, Generic
...
class BaseTransform(BaseModel):
    ...
    ) -> Tuple["BaseTransform", Dict[str, Any]]:
        result = {}
...
class TransformChain(BaseModel):
    ...
    def build(
        cls,
        chain: Union[Dict[str, BaseTransform], List[BaseTransform]],
        entry_id: str = "0",
    ) -> "TransformChain":
        _chain = {}
