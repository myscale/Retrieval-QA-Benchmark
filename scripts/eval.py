...
config["evaluator"]["transform"]["nodes"][-1]["args"]["num_selected"] = args.topk
print(
    f"Evaluating MMLU-{config['evaluator']['dataset']['args']['subset']} with "
    f"{config['evaluator']['transform']['nodes'][-1]['args']['num_selected']} supporting materials."
)
